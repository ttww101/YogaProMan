...
extension ScoreViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return LocalDataBase.instance.getScoreArray().count
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if let cell = scoreCollectionView.dequeueReusableCell(withReuseIdentifier: "scoreCollectionViewCell",
            ...
            let scoreArray = LocalDataBase.instance.getScoreArray()[indexPath.row]
...
extension ScoreViewController: UICollectionViewDelegate, UIScrollViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        for otherRow in 0...LocalDataBase.instance.getScoreArray().count {
        ...
        cell.layer.borderColor = #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1)
        cell.layer.borderWidth = 5
        print(LocalDataBase.instance.getScoreArray()[indexPath.row].titleLbl)
        
        scoreTitleLbl = LocalDataBase.instance.getScoreArray()[indexPath.row].titleLbl
    }
}
